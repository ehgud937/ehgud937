...
## Awards
- 2023 HD 현대 AI Challenge **장려상** ***(2023.11)***
> 선박 대기시간 예측 모델, Masked Data Label 예측 모델 개발

- LH 국토도시 데이터 분석 과제 **입선** ***(2021.04)***
> 세종시 지리 정보 분석 Tableau 및 시각화

- 동작구 빅데이터 활용 정책 공모전 **대상** ***(2020.05)***
> QGIS를 이용한 동작구 지리 정보 분석을 통한 복지버스 노선 신설

- 창원시 빅데이터 공모전 **최우수상** ***(2019.09)***
> K-means 알고리즘을 이용한 창원시 심야버스 시범노선 개발

## Military
해군 신기술융합연구병 ***(2021.04 ~ 2022.12)***
...
<span>
    <img src="https://img.shields.io/badge/ QGIS-yellow?style=plastic&logo=QGIS&logoColor=white"/>
</span>
<span>
...
<!-- My snake -->
<img src="https://github.com/ehgud937/ehgud937/blob/output/mysnake.svg" width="100%">
